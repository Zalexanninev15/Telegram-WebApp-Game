...
(function() {
    ...
    function urlAppendHashParams(url, addHash) {
        ...
        // addHash looks like 'tgShareScoreUrl=' + encodeURIComponent('tgb_3A//share_game_score@hash=very_long_hash123')
...
(function() {
    ...
    function setClosingConfirmation(need_confirmation) {
        ...
        WebView.postEvent('web_app_setup_closing_behavior', false, {
            need_confirmation: closingConfirmation
        });
    }
